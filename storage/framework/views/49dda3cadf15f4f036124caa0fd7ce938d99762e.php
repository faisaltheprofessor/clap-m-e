    ...
    <form action="/report/generate" method="get">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <?php echo e(Form::select('unit_id', $units, null, ['class' => 'form-control select2', 'placeholder' => 'Choose Unit...'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/faisal/Dropbox/My Mac (MacBook-Pro)/Documents/Developer/Sites/clap/resources/views/reports/index.blade.php ENDPATH**/ ?>