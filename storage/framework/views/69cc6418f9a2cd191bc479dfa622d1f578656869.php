...
<?php $__env->startSection('breadcrumb', Breadcrumbs::render('subcomponent')); ?>
                ...
                <div class="block-content">
                    <form action="/subcomponent" method="post" enctype="multipart/form-data" class="js-validation-bootstrap">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('component_id', $components, '', ['class' => 'form-control js-select2', 'placeholder' => '----', 'required' => 'required']); ?>
                ...
                <div class="block-content block-content-full">
                    ...
                    <table class="table tasdfdvfdsdffsadfsdafble-bordered table-striped table-vcenter js-dataTable-full">
                        ...
                        <?php $__currentLoopData = $subcomponents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcomponent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-center"><?php echo e($subcomponent->id); ?></td>
                                <td class="font-w600"><?php echo e($subcomponent->name); ?></td>
                                <td class="font-w600"><?php echo e($subcomponent->component->name); ?></td>
                                <td class="d-none d-sm-table-cell"><?php echo e($subcomponent->project->abbreviation); ?></td>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/faisal/Dropbox/My Mac (MacBook-Pro)/Documents/Developer/Sites/clap/resources/views/subcomponents/index.blade.php ENDPATH**/ ?>