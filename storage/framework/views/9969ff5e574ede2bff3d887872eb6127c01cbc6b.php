...
<body>
   ...
   <div id="loader">
    ...
    <div class="message">
        The system is going to fetch <?php echo e(App\MonthlyProgress::count()); ?> records from the database, which makes it computationally expensive. You will have to wait for a very long time until all reocrds are loaded. Thank you for your patience. It is worth mentioning that we are working hard to refactor the code so that it loads records fast and efficiently.
...
</html><?php /**PATH /Users/faisal/Dropbox/My Mac (MacBook-Pro)/Documents/Developer/Sites/clap/resources/views/datatable.blade.php ENDPATH**/ ?>