        ...
        <div class="col-md-6">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <form action="/scheme/<?php echo e($irrigation->id); ?>" method="post" enctype="multipart/form-data" class="js-validation-bootstrap">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-control custom-radio custom-control-inline mb-5">
                                <input class="custom-control-input" type="radio" name="project_id" id="project_id_1" value="1" <?php if($irrigation->project_id == 1): ?>checked <?php endif; ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline mb-5">
                                ...
                                <label class="custom-control-label" for="project_id_2" <?php if($irrigation->project_id == 2): ?>checked <?php endif; ?>>SNaPP2</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9" v-if="scheme">
                               <?php echo Form::select('scheme_id', $schemes, $irrigation->scheme_id, ['class' => 'form-control select2', 'placeholder' => 'Select Scheme...', 'required' => 'required']); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9" v-if="village">
                               <?php echo Form::select('village_id', $villages, $irrigation->village_id, ['class' => 'form-control select2', 'placeholder' => 'Select Village...', 'required' => 'required']); ?>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-9" v-if="IA">
                               <?php echo Form::select('ia_id', $IAs, $irrigation->ia_id, ['class' => 'form-control select2', 'placeholder' => 'Select IA...', 'required' => 'required']); ?>
                        ...
                        <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               <?php echo Form::text('start_point_long', $irrigation->start_point_long, ['class' => 'form-control', 'placeholder' => 'Longitude', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-6">
                                <?php echo Form::text('start_point_lat', $irrigation->start_point_lat, ['class' => 'form-control', 'placeholder' => 'Latitude', 'required' => 'required']); ?>  
                             </div>
                        </div>
                         ...
                         <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               <?php echo Form::text('end_point_long', $irrigation->end_point_long, ['class' => 'form-control', 'placeholder' => 'Longitude', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-6">
                                <?php echo Form::text('end_point_lat', $irrigation->end_point_long, ['class' => 'form-control', 'placeholder' => 'Latitude', 'required' => 'required']); ?>  
                             </div>
                        </div>
                       ...
                       <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="js-flatpickr form-control bg-white" id="start_date" name="start_date" placeholder="Y-m-d" value="<?php echo e($irrigation->start_date); ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="js-flatpickr form-control bg-white" id="end_date" name="end_date" placeholder="Y-m-d" value="<?php echo e($irrigation->end_date); ?>">
                            </div>
                       </div>
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-4">
                               <?php echo Form::text('total_command_area', $irrigation->total_command_area, ['class' => 'form-control', 'placeholder' => 'Total Command Area', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-4">
                                <?php echo Form::text('irrigated_area', $irrigation->irrigated_area, ['class' => 'form-control', 'placeholder' => 'Irrigated Area', 'required' => 'required']); ?>  
                             </div>

                             <div class="col-md-4">
                                <?php echo Form::text('nonirrigated_area', $irrigation->nonirrigated_area, ['class' => 'form-control', 'placeholder' => 'Nonirrigated Area']); ?>  
                             </div>
                        </div>
                         ...
                         <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               <?php echo Form::text('direct_beneficiaries', $irrigation->direct_beneficiaries, ['class' => 'form-control', 'placeholder' => 'Direct Beneficiaries', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-6">
                                <?php echo Form::text('indirect_beneficiaries',  $irrigation->indirect_beneficiaries, ['class' => 'form-control', 'placeholder' => 'Indirect Beneficiaries', 'required' => 'required']); ?>  
                             </div>
                        </div>
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               <?php echo Form::text('engineering_estimated_cost',  $irrigation->engineering_estimated_cost, ['class' => 'form-control', 'placeholder' => 'Afs', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-6">
                                <?php echo Form::text('engineering_estimated_cost_usd', $irrigation->engineering_estimated_cost_usd, ['class' => 'form-control', 'placeholder' => 'USD', 'required' => 'required']); ?>  
                             </div>
                        </div>
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               <?php echo Form::text('contract_cost', $irrigation->contract_cost, ['class' => 'form-control', 'placeholder' => 'Afs', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-6">
                                <?php echo Form::text('contract_cost_usd', $irrigation->contract_cost_usd, ['class' => 'form-control', 'placeholder' => 'USD', 'required' => 'required']); ?>  
                             </div>
                        </div>
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               <?php echo Form::text('project_status', $irrigation->project_status, ['class' => 'form-control', 'placeholder' => 'Project Status', 'required' => 'required']); ?>  
                            </div>

                            <div class="col-md-6">
                                <?php echo Form::text('remarks', $irrigation->remarks, ['class' => 'form-control', 'placeholder' => 'Remarks']); ?>  
                             </div>
                        </div>
                    ...
                    <table
                        ...
                        <tbody>
                                ...
                                <?php $__currentLoopData = $irrigationSchemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($x++); ?></td>
                                        <td><?php echo e($is->scheme->name); ?></td>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/faisal/Dropbox/My Mac (MacBook-Pro)/Documents/Sites/clap/resources/views/irrigation_schemes/edit.blade.php ENDPATH**/ ?>